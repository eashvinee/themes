<h2>Participants in Quiz</h2>
<p>Here is the list of quizzes your Participants. Your can dowload/View  participants quiz wise.</p>
<?php
    ...
    <?php
        ...
        while ( $the_query->have_posts() ):
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo home_url("/my-account?tab=participantsview&id=".$post_id); ?>" class="btn-link">View</a>  
              </td>
            </tr>
            <?php 
        endwhile;
